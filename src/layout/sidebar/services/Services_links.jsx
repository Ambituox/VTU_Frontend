...
export default function Services_links() {
  return (
    <div className="text-gray-400 mt-5">
        ...
        <p className="text-[12px] text-blue-500 pl-3 font-normal">SERVICES</p>
        <AccordionGroup disableDivider sx={{ maxWidth: 400 }}>
            ...
            <Accordion>
                <AccordionSummary color='white'>
                    <p className="text-gray-400 font-normal hover:text-blue-500 hover:translate-x-2 duration-150 flex items-center gap-3"><MdCall /> Buy Airtime</p>
                </AccordionSummary>
                <AccordionDetails>
                    <ul className="text-gray-400 flex flex-col gap-1 list-disc pl-10">
                        {/* <li className='hover:text-blue-500 hover:translate-x-2 duration-150'>
            ...
            <Accordion>
                <AccordionSummary color='white'>
                    <p className="text-gray-400 font-normal hover:text-blue-500 hover:translate-x-2 duration-150 flex items-center gap-3"><FaLightbulb />Utility Payment</p>
                </AccordionSummary>
                <AccordionDetails>
                    <ul className="text-gray-400 flex flex-col gap-1 list-disc pl-10">
                        <li className='hover:text-blue-500 hover:translate-x-2 duration-150'>
